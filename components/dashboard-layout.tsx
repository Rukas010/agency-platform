...
import { Building2, LayoutDashboard, Users, Star, MessageSquare, Settings, Menu, X, LogOut } from 'lucide-react';
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400 capitalize">{reseller?.plan} Plan</div>
              </div>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
